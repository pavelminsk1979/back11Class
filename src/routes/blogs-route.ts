...
class BlogsController {
    ...
    async getBlogs(req: RequestWithQuery<QueryBlogInputModal>, res: Response){
        const sortData = {
    ...
    async getBlogById(req: RequestWithParams<IdStringGetAndDeleteModel>, res: Response){
    ...
    async getPostsFromCorrectBlog(req: RequestWithParamsWithQuery<ParamBlogId,GetQueryBlogInputModal>, res: Response){
    ...
    async createPostForCorrectBlog(req: RequestWithParamsWithBody<ParamBlogId,CreatePostFromCorrectBlogInputModel>, res: Response){
        const blogId = req.params.blogId
    ...
    async updateCorrectBlog(req: RequestWithParamsWithBody<IdStringGetAndDeleteModel, CreateAndUpdateBlogModel>, res: Response){
    ...
    async deleteCorrectBlog(req: RequestWithParams<IdStringGetAndDeleteModel>, res: Response){
...
blogsRoute.get('/',blogsController.getBlogs )


blogsRoute.get('/:id',blogsController.getBlogById)


blogsRoute.get('/:blogId/posts', blogsController.getPostsFromCorrectBlog)
...
blogsRoute.post('/:blogId/posts',
    ...
    errorValidationBlogs,
    blogsController.createPostForCorrectBlog)
...
blogsRoute.put('/:id',
    ...
    postValidationBlogs(),
    errorValidationBlogs,
    blogsController.updateCorrectBlog)


blogsRoute.delete('/:id',
    authMiddleware,
    blogsController.deleteCorrectBlog)
